<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" EnableEventValidation="false" CodeBehind="frmMantenimientoUsuarios.aspx.cs" Inherits="UI.WebForms.Mantenimientos.Usuarios.frmMantenimientoUsuarios" %>
        ...
        <div style="height: 360px; margin-bottom: 110px; margin-left: auto; width: 1200px;">
            ...
            <div class="divCentradoTitulosPrincipal">
                ...
                <div class="divCentradoTitulosSecundario">
                    <asp:Label ID="lbTitulo" runat="server" CssClass="titulo" Text="Mantenimiento de Usuarios"></asp:Label>
                </div>
            ...
            <asp:Table runat="server" ID="tbMantenimientoUsuarios">
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:GridView ID="tablaUsuarios" runat="server" AllowPaging="true" DataKeyNames="ID_Usuario" 
                            OnRowDataBound="tablaUsuarios_RowDataBound" AutoGenerateColumns="false" OnDataBinding="tablaUsuarios_DataBinding"
                            OnSelectedIndexChanged="tablaUsuarios_SelectedIndexChanged">
                            <Columns>
